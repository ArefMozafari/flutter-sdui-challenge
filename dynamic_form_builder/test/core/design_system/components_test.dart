...
void main() {
  group('DsFieldLabel', () {
    testWidgets('shows a required marker only when asked', (tester) async {
      await tester.pumpWidget(
        _wrap(const DsFieldLabel('Brand', isRequired: true)),
      );
  ...
  group('DsTextField', () {
    testWidgets('reports typed text and keeps its own cursor across rebuilds', (
      tester,
    ) async {
      final changes = <String>[];
      await tester.pumpWidget(
        _wrap(DsTextField(label: 'Brand', onChanged: changes.add)),
      );
    ...
    testWidgets('surfaces an external error message', (tester) async {
      await tester.pumpWidget(
        _wrap(
          DsTextField(label: 'Brand', errorText: 'Required', onChanged: (_) {}),
        ),
      );
  ...
  group('DsSelect', () {
    testWidgets('reports the chosen option value, not its label', (
      tester,
    ) async {
      String? picked;
      await tester.pumpWidget(
  ...
  group('DsFilePicker', () {
    testWidgets('renders one chip per selected file and reports pick taps', (
      tester,
    ) async {
